 ...
 */
declare const HookFormControlledCheckbox: ({ checkTheme, control, disabled, error, id, inputTheme, name, onBlur, onChange, onFocus, optional, register, required, theme, title, titleTheme, validation, }: HookFormControlledCheckboxProps) => React.JSX.Element;
