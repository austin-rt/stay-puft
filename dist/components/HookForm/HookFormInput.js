...
validation, watch, }) => {
    ...
    const fld = Object.assign(Object.assign({}, field), { type: field.type ||
            ...
            'text', autoComplete: mapAutoComplete(field.name) || 'off' });
    ...
    if (fld.name === 'captcha' || fld.type === 'captcha')
    ...
    return (React.createElement("div", { className: "relative" },
        fld.name === 'state' && (React.createElement(StateDropDown, { disabled: fld === null || fld === void 0 ? void 0 : fld.disabled, error: ((_a = errors[fld.name]) === null || _a === void 0 ? void 0 : _a.message) || '', formId: formId, name: fld.name, onBlur: fld === null || fld === void 0 ? void 0 : fld.onBlur, onChange: (e) => {
                ...
                handleOnChange(e);
            }, onFocus: fld === null || fld === void 0 ? void 0 : fld.onFocus, register: register, title: fld.title, validation: validation, required: fld.required })),
        fld.type === 'textarea' && (React.createElement(HookFormTextArea, { autoComplete: fld.autoComplete, autoCorrect: fld.autoCorrect || 'off', disabled: fld === null || fld === void 0 ? void 0 : fld.disabled, error: ((_b = errors[fld.name]) === null || _b === void 0 ? void 0 : _b.message) || '', id: `${formId}--${fld.name}`, name: fld.name, onBlur: fld === null || fld === void 0 ? void 0 : fld.onBlur, onChange: (e) => {
                if (fld === null || fld === void 0 ? void 0 : fld.onChange)
                    fld === null || fld === void 0 ? void 0 : fld.onChange(e);
                handleOnChange(e);
            }, onFocus: fld === null || fld === void 0 ? void 0 : fld.onFocus, onKeyDown: fld === null || fld === void 0 ? void 0 : fld.onKeyDown, onKeyUp: fld === null || fld === void 0 ? void 0 : fld.onKeyUp, optional: fld.optional, placeholder: fld.placeholder, register: register, required: fld.required, spellCheck: fld.spellCheck || false, title: fld.title, validation: validation })),
        fld.type === 'radio' &&
            (fld.options ? (React.createElement(HookFormRadio, { disabled: fld === null || fld === void 0 ? void 0 : fld.disabled, error: ((_c = errors[fld.name]) === null || _c === void 0 ? void 0 : _c.message) || '', name: fld.name, onBlur: fld === null || fld === void 0 ? void 0 : fld.onBlur, onChange: (e) => {
                    if (fld === null || fld === void 0 ? void 0 : fld.onChange)
                        fld === null || fld === void 0 ? void 0 : fld.onChange(e);
                    handleOnChange(e);
                }, onFocus: fld === null || fld === void 0 ? void 0 : fld.onFocus, optional: fld.optional, options: fld.options, register: register, required: fld.required, title: fld.title, validation: validation, verticalSpacing: spacing })) : (throwError('Radio field must have options'))),
        fld.type === 'checkbox' && (React.createElement(HookFormCheckbox, { checkTheme: fld.checkTheme, disabled: fld === null || fld === void 0 ? void 0 : fld.disabled, error: ((_d = errors[fld.name]) === null || _d === void 0 ? void 0 : _d.message) || '', id: `${formId}--${fld.name}`, name: fld.name, onBlur: fld === null || fld === void 0 ? void 0 : fld.onBlur, onChange: (e) => {
                if (fld === null || fld === void 0 ? void 0 : fld.onChange)
                    fld === null || fld === void 0 ? void 0 : fld.onChange(e);
                handleOnChange(e);
            }, onFocus: fld === null || fld === void 0 ? void 0 : fld.onFocus, optional: fld === null || fld === void 0 ? void 0 : fld.optional, register: register, required: fld === null || fld === void 0 ? void 0 : fld.required, theme: fld.theme, title: fld.title, titleTheme: fld.titleTheme, validation: validation }))
    // )
    ,
        fld.type === 'select' &&
            (fld.options ? (React.createElement(HookFormSelect, { disabled: fld === null || fld === void 0 ? void 0 : fld.disabled, error: ((_e = errors[fld.name]) === null || _e === void 0 ? void 0 : _e.message) || '', formId: formId, id: `${formId}--${fld.name}`, labelTheme: fld.titleTheme, name: fld.name, onBlur: fld === null || fld === void 0 ? void 0 : fld.onBlur, onChange: (e) => {
                    if (fld === null || fld === void 0 ? void 0 : fld.onChange)
                        fld === null || fld === void 0 ? void 0 : fld.onChange(e);
                    handleOnChange(e);
                }, onFocus: fld === null || fld === void 0 ? void 0 : fld.onFocus, optional: fld === null || fld === void 0 ? void 0 : fld.optional, options: fld.options, register: register, required: fld === null || fld === void 0 ? void 0 : fld.required, selectTheme: fld.selectTheme, theme: fld.theme, title: fld.title, validation: validation })) : (throwError('Select field must have options'))),
        fld.type && !nonTextInputTypes.includes(fld.type) && (React.createElement(HookFormTextInput, { autoComplete: fld.autoComplete, disabled: fld === null || fld === void 0 ? void 0 : fld.disabled, error: ((_f = errors[fld.name]) === null || _f === void 0 ? void 0 : _f.message) || '', id: `${formId}--${fld.name}`, name: fld.name, onBlur: fld === null || fld === void 0 ? void 0 : fld.onBlur, onChange: (e) => {
                if (fld === null || fld === void 0 ? void 0 : fld.onChange)
                    fld === null || fld === void 0 ? void 0 : fld.onChange(e);
                handleOnChange(e);
            }, onFocus: fld === null || fld === void 0 ? void 0 : fld.onFocus, onKeyDown: fld === null || fld === void 0 ? void 0 : fld.onKeyDown, onKeyUp: fld === null || fld === void 0 ? void 0 : fld.onKeyUp, optional: fld === null || fld === void 0 ? void 0 : fld.optional, placeholder: ((_g = errors[fld.name]) === null || _g === void 0 ? void 0 : _g.message) ? '' : fld.placeholder, register: register, required: fld === null || fld === void 0 ? void 0 : fld.required, resetButton: fld.resetButton, resetCallback: resetField, 
